...
# -*- coding: utf-8 -*-
#
# fastparquet documentation build configuration file, created by
...
htmlhelp_basename = 'fastparquetdoc'
...
latex_documents = [
    (master_doc, 'fastparquet.tex', 'fastparquet Documentation',
...
man_pages = [
    (master_doc, 'fastparquet', 'fastparquet Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'fastparquet', 'fastparquet Documentation',
     author, 'fastparquet', 'One line description of project.',
     'Miscellaneous'),
]
